...
const Menpromocard:React.FC<Cardprops> = ({
  ...
  return (
    <div className="mb-3 md:ml-8 h-[450px] md:w-72 sm:w-60 relative" style={{backgroundColor: bgroundColor}}>
      ...
      <div className="absolute top-3 px-4">
        ...
        <div className="bg-white rounded-full w-fit ml-48 mt-[19.5rem] p-4">
          <FaChevronRight />
        </div>
      </div>
    </div>
